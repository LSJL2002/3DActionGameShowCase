...
public class KeybindButton : MonoBehaviour
{
    ...
    //public SettingsManager.Action action;
    ...
    //{
    //    buttonText.text = SettingsManager.Instance.GetKeybind(action).ToString();
    //}

    //private void StartKeyRebinding()
    //{
    //    // 모든 키 변경 프로세스를 중단하고 새 키 변경 프로세스 시작
    //    SettingsManager.Instance.StartRebindProcess(action, this);
    //}
}