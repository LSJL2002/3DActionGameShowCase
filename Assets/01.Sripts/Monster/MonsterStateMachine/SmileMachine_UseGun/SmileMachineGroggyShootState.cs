...
public class SmileMachineGroggyShoot : MonsterBaseState
{
    private MonsterSkillSO skillData;
    private Coroutine shootRoutine;

    public SmileMachineGroggyShoot(MonsterStateMachine ms, MonsterSkillSO shootSkill) : base(ms)
    {
    ...
    private IEnumerator ShootRoutine()
    {
        ...
        {
            machine.groggyParticleEffect.SetActive(true);
        }
