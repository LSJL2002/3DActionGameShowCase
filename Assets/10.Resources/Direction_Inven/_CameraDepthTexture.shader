...
Shader "Custom/DepthShadowColor_Fix2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float sceneDepth = SampleLinearDepth(screenUV);

                float shadowFactor = smoothstep(_DepthCutoff, _DepthCutoff + _Softness, sceneDepth);
